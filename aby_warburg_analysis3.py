...
if uploaded_file:
    ...
    if st.button("Analyze Words"):
        ...
        if st.checkbox("Show Word Connection Network"):
            G = nx.Graph()
        ...
        if st.checkbox("Show Co-occurrence Matrix Heatmap"):
        ...
        if st.checkbox("Show Bigram Network"):
        ...
        if st.checkbox("Show LDA Topic Modeling"):
        ...
        if st.checkbox("Show Word Embeddings (PCA)"):
        ...
        if st.checkbox("Show Dependency Parsing (spaCy)"):
